...
In ERPLite, an asset is an entity that represents a piece of equipment in an organization. For example, in an office facility, the Air conditioner could be an asset. Also is the water dispenser.
...
## Asset Types
Assets can have types. Asset types can be used to categorize the assets. ERPLite provides some default asset types here. But you can also add your custom asset types.

- For more information about asset types, see [Create an Asset](https://docs.erplite.app/cmms/create_assets#creating-an-asset).
- For more information about viewing assets, see [Viewing Assets](https://docs.erplite.app/cmms/create_assets#view-assets)
...
## Asset Status
An asset’s status represents the state of the asset. An asset in ERPLite can have the following statuses:
...
## Asset Depreciation
ERPLite automatically provides the current value of the assets post depreciation using your chosen depreciation methods.
...
![Asset_uptime](../images/Asset_uptime.png)
...
![Asset_Workorders](../images/Asset_Workorders.png)
...
![permissionsentry](../images/permissionsentry.png)

## Reporting
All asset details are provided under [Reports -> Asset Health](https://cmms.erplite.app/#/bireports/Reports).
Comprehensive reports cover your lifecycle of the assets, operating time, downtime, most expensive assets and more.

![Asset_Reports](../images/Asset_Reports.png)
