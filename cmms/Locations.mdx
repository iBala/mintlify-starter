...
In ERPLite, a location is an entity that represents a physical place where your company operates. Here are some important concepts about locations.
...
For details, see [Create a Location](https://docs.erplite.app/cmms/Locations)

# Locations and Other ERPLite Entities

This section explains how Locations connect to other ERPLite entities.
...
For more information on assets, see [About Assets](https://docs.erplite.app/cmms/assets)
...
For more information, see [Create a Work order](https://docs.erplite.app/cmms/WorkOrders#how-to-create-a-work-order)
...
3. Default Assignee (Optional): This is the default user assigned to work orders at this location. (Must be an existing ERPLite user)
