...
In Zorp, a location is an entity that represents a physical place where your company operates.

Adminis can create and manage locations for an organization. For more information, see [Create a Location](https://example.com)
...
For more information, see [Create a Workorder](https://example.com)
...
|-------------------|---------------------------------|
| Location Name     | The name of the location.It can be up to 255 characters long.<br>You cannot create a location without a name. |
| Address           | This is the address.<br>It could be a street name or a city. You can also provide Latitude and Longitude. <br>You cannot create a location without a location.   |
| Default Assignee  | This is the default assignee.<br>It can be any existing user on Zorp. |
| Assets            | These are the assets.It could be equipment or furniture. <br> For more information on assets, see [About Assets](https://example.com)  |
...
## Customize Locations
1. From the sidebar, select Locations. image[Add Sidebar image here]
2. Click on the Add + button. image[SS with annotation on + Location button]
3. Enter the name of the field you want to add. image[SS with annotation on field]
4. Select the field type. image[SS with annotation on field type]
5. Click on Save. image[SS with annotation on Save button]
