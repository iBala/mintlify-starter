...
| Address           | This is the address.<br>It could be a street name or a city. You can also provide Latitude and Longitude. <br>You cannot create a location without an address.   |
