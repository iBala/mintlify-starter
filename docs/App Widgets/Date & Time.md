...
The Date & Time is a Input Component where you can select a Date/ Datetime.

## Setting up a Date & Time Component
...
Your Date & Time component is ready to click :)

## Where can I use this?

1. Recheduling an appointment  
2. Collecting the time when a customer wants product to be collected.