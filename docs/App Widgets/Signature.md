...
The Signature component is a Input Component where you can capture the signature as an Image.

## Setting up a Signature Component
...
1. KYC Verification 
2. Delivery confirmation signature