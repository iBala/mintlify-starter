...
# What's New
For faster updates, follow us on [Twitter](https://twitter.com/zorp_one)
...
Remember uploading images one by one? It was hard. You asked and we listened. Now, you can upload multiple images seamlessly via camera or gallery using the brand new image component. This one's gonna save a tone of time while uploading images. 

Not just that, we made the image upload to happen in the background. You no longer have to wait for all the images to upload before you continue your task. More power to you!

<Insert Gif for Image Upload>
